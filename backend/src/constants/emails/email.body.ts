...
const welcomeEmailBody = (username: string) => {
    return emailLayout(`
    <p>Hello ${username},</p>
    <p>Welcome to NexusChat! We're excited to have you on board. Our application offers a range of features designed to enhance your communication experience:</p>
    <ul>
    ...
    <p>We're constantly working to improve NexusChat and add new features. If you have any questions or feedback, feel free to reach out to us at <a href="mailto:NexusChat.online@gmail.com">NexusChat.online@gmail.com</a>.</p>
    <p>Thank you for joining us. We look forward to helping you stay connected!</p>
    <p>Best regards,<br>The NexusChat Team</p>`,'welcome'
    )
};
...
const resetPasswordBody = (username: string, resetUrl: string) => {
    return emailLayout(`
        ...
        <p>If you continue to have trouble accessing your account, please contact our support team at <a href="mailto:NexusChat.online@gmail.com">NexusChat.online@gmail.com</a>.</p>
        <p>Thanks,</p>
        <p>The NexusChat Team</p>
    `,'resetPassword')
};
...
const privateKeyRecoveryBody = (username:string,verificationUrl:string) => {
    return emailLayout(`
        <p>Hello ${username},</p>
        <p>We received a request to recover the private key associated with your NexusChat account. Your private key is essential for decrypting messages and ensuring the confidentiality of your communication.</p>
